...
def get_columns():
    return [
        ...
        {"fieldname": "raw_item", "fieldtype": "Data", "label": "Raw Item", "width": 200},
        {"fieldname": "quantity", "fieldtype": "Int", "label": "Quantity", "width": 200},
        {"fieldname": "machine_type", "fieldtype": "Data", "label": "Machine Type", "width": 200},
        {"fieldname": "cycle_time", "fieldtype": "Float", "label": "Cycle Time", "width": 200},
        {"fieldname": "total_time", "fieldtype": "Float", "label": "Total Time", "width": 200},
	]
...
def get_data(filters=None):
    ...
    query = f"""
        SELECT
            ...
            mop.machine_type,
            mop.cycle_time,
            (soi.qty * mop.cycle_time) AS total_time
